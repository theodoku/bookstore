...
In this project, I am using React to create a bookstore website.
...
Command : git clone https://github.com/theodoku/bookstore.git
...
Feel free to check the [issues page](https://github.com/theodoku/bookstore.git/issues/).
